...
class XLite_Web_Customer_UserDetails extends XLite_Web_Customer_ACustomer
{
    ...
    public function testRoles()
    {
        ...
        $this->traceTime("Add role to users");
        ...
        foreach ($userIds as $userId) {
         ...
         $this->traceTime("Check profiles are customers");
    }
    ...
    protected $lastTime;
    function traceTime($msg = ""){
        if (!$this->lastTime)
            $this->lastTime = $this->startTime;
        print "\n " . $msg . ": " . (microtime(true) - $this->lastTime);
